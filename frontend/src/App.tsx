	...
	return (
		<div className="min-h-screen bg-gray-900 text-white py-16 px-4">
			<div className="max-w-6xl mx-auto">
				...
				<p className="text-gray-400 text-center mb-16">Building something awesome together</p>
		...
		>
			...
			{stats && (
				<div className="flex justify-center gap-6 text-sm">
					<div>
						<div className="text-2xl font-bold text-blue-400">{stats.public_repos}</div>
